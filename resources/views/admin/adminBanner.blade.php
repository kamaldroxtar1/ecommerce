    ...
    <div class="container">
        ...
        <table class="table table-bordered">
            ...
            <tbody>
                ...
                <tr>
                    <td><img src="{{ asset('banner/'.$item->banner_name)}}" height="200px" width="700px"></td>
                    <td>{{$item->description}}</td>
                    <td>
                        <a href="/admin/banner/delete/{{$item->id}}"  onclick="return confirm('Are you sure?')" class="btn btn-danger ">Delete</a>
